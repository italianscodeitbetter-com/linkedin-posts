...
export function LoginForm({
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setSubmitting(true)
        const { error } = await signInWithPassword(emailInput, password)
        setSubmitting(false)
    ...
    const handlePasswordReset = async () => {
        ...
        toast.success('Ti abbiamo inviato una mail per reimpostare la password')
    }
            ...
            <FieldGroup>
                <div className="flex flex-col items-center gap-1 text-center">
                    ...
                    <p className="text-sm text-balance text-muted-foreground">
                        Scegli come accedere al portale
                    </p>
                </div>
                ...
                <Field>
                    ...
                    <Input
                        ...
                        autoComplete="email"
                        required
                        disabled={submitting || oauthBusy || resetBusy}
                        value={email}
                ...
                <Field>
                    <div className="flex items-center">
                        ...
                        <button
                            ...
                            disabled={submitting || oauthBusy || resetBusy}
                        >
                            {resetBusy ? 'Invio in corso...' : 'Password dimenticata?'}
                        </button>
                    </div>
                    <Input
                        id="password"
                ...
                <Field>
                    <Button
                        type="submit"
                        disabled={!supabaseReady || submitting || oauthBusy || resetBusy}
                    >
